        ...
        if local == 1:
            ...
            while True:
                decidir = int(input("Digite 1 para cadastrar uma fornecedor\n"
                                     ...
                                     "Digite 4 para mostrar uma fornecedor\n"
                                     "Digite 5 para sair\n"))
                ...
                if decidir == 1:
                    ...
                    nomeAlterar = input('Digite o nome do fornecedorque deseja alterar: \n')
                    novoNome = input('Digite o novo nome do fornecedor: \n')
                    novoCnpj = input('Digite o novo cnpj do fornecedor: \n')
                    novoTelefone = input('Digite o nova telefone do fornecedor: \n')
                    novoCategoria = input('Digite a nova categoria do fornecedor: \n')
            ...
            while True:
                decidir = int(input("Digite 1 para cadastrar um cliente\n"
                                    ...
                                    "Digite 4 para mostrar um cliente\n"
                                    "Digite 5 para sair\n"))
                ...
                if decidir == 1:
                    ...
                    nomeAlterar = input('Digite o nome do cliente deseja alterar:\n')
            ...
            while True:
                decidir = int(input("Digite 1 para cadastrar um funcionario\n"
                                    ...
                                    "Digite 4 para mostrar um funcionario\n"
                                    "Digite 5 para sair\n"))
                ...
                if decidir == 1:
                    ...
                    nomeAlterar = input('Digite o nome do funcionario deseja alterar:\n')
                    novaClt = input('Digite a clt do novo funcionario: \n')
                    novoNome = input('Digite o nome do novo funcionario: \n')
                    novoTelefone = input('Digite o telefone do novo funcionario: \n')
                    novoCpf = input('Digite o cpf do novo funcionario: \n')
                    novoEmail = input('Digite o email do novo funcionario: \n')
                    novoEndereco = input('Digite o endereço do novo funcionario: \n')
                    cat.alterarFuncionario(nomeAlterar, novaClt, novoNome, novoTelefone, novoCpf, novoEmail, novoEndereco)
                elif decidir == 4:
